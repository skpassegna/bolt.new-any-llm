...
function getEditorTheme(settings: EditorSettings) {
  return EditorView.theme({
    ...
    '.cm-tooltip.cm-readonly-tooltip': {
      padding: '4px',
      whiteSpace: 'nowrap',
      backgroundColor: 'var(--ottodev-elements-bg-depth-2)',
      borderColor: 'var(--ottodev-elements-borderColorActive)',
      '& .cm-tooltip-arrow:before': {
        borderTopColor: 'var(--ottodev-elements-borderColorActive)',
      },
