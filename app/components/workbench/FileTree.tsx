  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-ottodev-elements-item-contentDefault hover:text-ottodev-elements-item-contentActive hover:bg-ottodev-elements-item-backgroundActive':
          !selected,
        'bg-ottodev-elements-item-backgroundAccent text-ottodev-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-ottodev-elements-item-backgroundActive text-ottodev-elements-item-contentDefault': !selected,
        'bg-ottodev-elements-item-backgroundAccent text-ottodev-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-ottodev-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
